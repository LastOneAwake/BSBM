...
import EMSculptIcon from '../assets/images/icons/EMSculpt_supplied_2.jpg';
import laserLipoIcon from '../assets/images/icons/laserLipo_supplied.png';
...
const laserLipoObj = {
    ...
    description: 'Cavitation refers to the scientific phenomenon for wound healing after liposuction surgery and lymphatic drainage. The ultrasound handpiece emits a specific frequency of vibration into the subcutaneous layer, that causes immense pressure to build up inside the fat cells to dissolve and drain access fluids from underneath the skin. We recommend a minimum of 4 to 8 sessions for best results. By following the ultrasound fat cavitation after care plan, the results will more and more visible. It is a non-invasive treatment that requires no downtime, and offers results which are comparable to liposuction. ',
    ...
    more: <div>
        ...
        <ul>
            ...
            <li>Wood Therapy - Loosens tight muscles, burns fat, and breaks down ceullulite.</li>
        </ul>
    </div>
};
